    ...
    <div className="mx-auto max-w-4xl p-6 py-12">
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <section className="bg-red-50 border-2 border-red-300 rounded-lg p-6">
          <h2 className="text-2xl font-semibold text-red-900 mb-4">⚠️ Critical Disclaimers</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">Positioning Relative to NAIC</h2>
          <div className="space-y-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">Positioning Relative to MIB</h2>
          <div className="space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">Information Release Process</h2>
          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Certified Court Orders</h3>
              <p className="text-slate-700 leading-relaxed mb-2">
            ...
            <div>
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Proof of Direct Heirship</h3>
              <p className="text-slate-700 leading-relaxed mb-2">
            ...
            <div>
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Global Database Access</h3>
              <p className="text-slate-700 leading-relaxed mb-2">
              ...
              <p className="text-slate-700 leading-relaxed mt-2 text-sm">
            ...
            <div>
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Standardized Release Method</h3>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">Regulatory Compliance</h2>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">No Legal Advice</h2>
          <p className="text-slate-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">Contact for Information Releases</h2>
          <p className="text-slate-700 leading-relaxed">
            For information about the standardized release process, certified court orders, or proof of 
            heirship requirements, please contact us at legal@heirvault.com
          </p>
        </section>
      </div>
    </div>
