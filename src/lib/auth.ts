...
// Re-export requireAdmin from admin.ts to ensure single source of truth
// The admin module is the authoritative source for admin access control
export { requireAdmin } from "@/lib/admin";
